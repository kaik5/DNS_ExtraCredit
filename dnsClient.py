...
def dns_query(type, name, server):
    ...
    qname_encoded = b''.join(qname_encoded_parts) + b'\x00'  # Null byte to terminate the domain name
    ...
    for _ in range(ANCOUNT):
        ...
        type, cls, ttl, rdlength = struct.unpack('!HHIH', response_answer[offset:offset + 10])  # RDLENGTH is a 2-byte field, TTL is 4 bytes
